 ...
 */
Instruction::Instruction(const char *mnemonic, bool preferred_mnemonic, opcodes_e opcode, const char *description) : _mnemonic(mnemonic), _opcode(opcode), _description(description), _preferred_mnemonic(preferred_mnemonic)
{
}
